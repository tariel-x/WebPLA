...
public class ClientError extends TException implements org.apache.thrift.TBase<ClientError, ClientError._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ClientError");
  ...
  static {
    schemes.put(StandardScheme.class, new ClientErrorStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ClientErrorTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ClientError.class, metaDataMap);
  }
  ...
  public ClientError setWhat(int what) {
    this.what = what;
    setWhatIsSet(true);
    return this;
  }
  ...
  public ClientError setWhy(String why) {
    this.why = why;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ClientError)
      return this.equals((ClientError)that);
    return false;
  }

  public boolean equals(ClientError that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ClientError other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ClientError typedOther = (ClientError)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ClientError(");
    boolean first = true;
  ...
  private static class ClientErrorStandardSchemeFactory implements SchemeFactory {
    public ClientErrorStandardScheme getScheme() {
      return new ClientErrorStandardScheme();
    }
  }

  private static class ClientErrorStandardScheme extends StandardScheme<ClientError> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ClientError struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClientError struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ClientErrorTupleSchemeFactory implements SchemeFactory {
    public ClientErrorTupleScheme getScheme() {
      return new ClientErrorTupleScheme();
    }
  }

  private static class ClientErrorTupleScheme extends TupleScheme<ClientError> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ClientError struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ClientError struct) throws org.apache.thrift.TException {
