...
public class SystemError extends TException implements org.apache.thrift.TBase<SystemError, SystemError._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SystemError");
  ...
  static {
    schemes.put(StandardScheme.class, new SystemErrorStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SystemErrorTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SystemError.class, metaDataMap);
  }
   ...
   */
  public SystemError(SystemError other) {
  ...
  public SystemError setWhat(int what) {
    this.what = what;
    setWhatIsSet(true);
    return this;
  }
  ...
  public SystemError setWhy(String why) {
    this.why = why;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SystemError)
      return this.equals((SystemError)that);
    return false;
  }

  public boolean equals(SystemError that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SystemError other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SystemError typedOther = (SystemError)other;
  ...
  private static class SystemErrorStandardSchemeFactory implements SchemeFactory {
    public SystemErrorStandardScheme getScheme() {
      return new SystemErrorStandardScheme();
    }
  }

  private static class SystemErrorStandardScheme extends StandardScheme<SystemError> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SystemError struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SystemError struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SystemErrorTupleSchemeFactory implements SchemeFactory {
    public SystemErrorTupleScheme getScheme() {
      return new SystemErrorTupleScheme();
    }
  }

  private static class SystemErrorTupleScheme extends TupleScheme<SystemError> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SystemError struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SystemError struct) throws org.apache.thrift.TException {
